            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">CLINIQUE DE LA VILLE</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <a href="patients.php" name="connect" class="btn btn-primary w-100" type="submit">Login</a>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="#">CLINIQUE DE LA VILLE</a>
              </div>
